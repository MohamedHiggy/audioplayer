<template>
  <div class="card shadow-sm">
    <div class="card-img-top" :class="[ getcurrentAudio && getcurrentAudio.id == item.id && getAudioPaused ? 'cardVisible': '']">
      ...
      <div class="play-box">
        <button
          v-if="getcurrentAudio" :disabled="getcurrentAudio && getcurrentAudio.id == item.id && getAudioPaused"
          class="play-btn"
          @click="playAudio">

            <div v-if="getcurrentAudio && getcurrentAudio.id == item.id && getAudioPaused"
              class="sound-wrapper w-full">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32" v-else>
            <g id="Group_28436" data-name="Group 28436" transform="translate(-167 -738)">
              ...
              <path id="Path_233489" data-name="Path 233489" d="M3.76,8.1v12.85A3.432,3.432,0,0,0,8.9,23.914L14.475,20.7l5.573-3.223a3.416,3.416,0,0,0,0-5.922L14.475,8.338,8.9,5.128A3.428,3.428,0,0,0,3.76,8.1Z" transform="translate(170.239 739.335)" fill="#2a6592"/>
            </g>
          </svg>
        </button>
      </div>
